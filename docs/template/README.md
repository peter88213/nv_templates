[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/nv_templates/raw/main/dist/nv_templates_v$Version.pyz)
...
Download the latest release [nv_templates_v$Version.pyz](https://github.com/peter88213/nv_templates/raw/main/dist/nv_templates_v$Version.pyz) ($PyzSize)

- Launch *nv_templates_v$Version.pyz* by double-clicking (Windows desktop),
- or execute `python nv_templates_v$Version.pyz` (Windows), resp. `python3 nv_templates_v$Version.pyz` (Linux) on the command line.
...
The package is also available in zip format: [nv_templates_v$Version.zip](https://github.com/peter88213/nv_templates/raw/main/dist/nv_templates_v$Version.zip) ($ZipSize)

- Extract the *nv_templates_v$Version* folder from the downloaded zipfile "nv_templates_v$Version.zip".
