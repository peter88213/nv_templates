...
[Download the latest release (version 0.99.0)](https://github.com/peter88213/nv_templates/raw/main/dist/nv_templates_v0.99.0.pyzw)

- Extract the "nv_templates_v0.99.0" folder from the downloaded zipfile "nv_templates_v0.99.0.pyzw".
