...
[Download the latest release (version 1.0.1)](https://github.com/peter88213/noveltree_templates/raw/main/dist/nv_templates_v1.0.1.zip)

- Extract the "nv_templates_v1.0.1" folder from the downloaded zipfile "nv_templates_v1.0.1.zip".
